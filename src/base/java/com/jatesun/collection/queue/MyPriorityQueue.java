package com.jatesun.collection.queue;
...
//import java.util.PriorityQueue.Itr;
//import java.util.PriorityQueue.PriorityQueueSpliterator;
...
public class MyPriorityQueue<E> extends AbstractQueue<E> implements java.io.Serializable {
	...
	// PriorityQueueSpliterator(MyPriorityQueue<E> myPriorityQueue, int origin,
	// int fence,
	// int expectedModCount) {
	// this.pq = myPriorityQueue;
	// this.index = origin;
	// this.fence = fence;
